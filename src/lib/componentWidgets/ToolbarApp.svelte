<script>
	...
	import { toolbarState, updateToolbarForRoute, toggleStudiesPanel, toggleComparison, toggleHeadings, toggleConnections, toggleNotes, toggleReferences, toggleVerses, toggleWide, toggleOverview, toggleCommentary, setZoomLevel } from '$lib/stores/toolbar.js';
