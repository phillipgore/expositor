<script>
	...
	import { toolbarState, updateToolbarForRoute, toggleStudiesPanel, toggleNotes, toggleVerses, toggleWide, toggleOverview, setZoomLevel } from '$lib/stores/toolbar.js';
